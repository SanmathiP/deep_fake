"""Makes the training run for the normal model"""
import pandas as pd
import torch
...
from make_dataset_dataloader_video import get_device , shift_to_device , make_train_val_dataset
from make_dataset_dataloader_video import GPUDataLoader
from create_model_pretrained import ResNetModel

MODALITY = 'VideoNormal'
...
## Making datasets ##
train_dataset , val_dataset = make_train_val_dataset(DATA_PATH , split_ratio=0.8 , ensemble = False)

## Creating dataloaders ##
train_dataloader = DataLoader(train_dataset , batch_size = 64 , shuffle = True , num_workers=8 , prefetch_factor=10) 
val_dataloader = DataLoader(val_dataset , batch_size = 64 , shuffle = True , num_workers=8 , prefetch_factor=10)
